...
insert into book (title, author, year_of_production, person_id, taken_at)
values ('Над пропастью во ржи', 'Джером Сэлинджер', 1951, 1, current_date - 10);
insert into book (title, author, year_of_production, person_id, taken_at)
values ('День опричника', 'Владимир Сорокин', 2006, 1, current_date);
insert into book (title, author, year_of_production)
values ('Тайные виды на гору Фудзи', 'Владимир Пелевин', 2018);
insert into book (title, author, year_of_production)
values ('Философиия Java', 'Брюс Эккель', 2018);
insert into book (title, author, year_of_production)
values ('Психопаталогия обыденной жизни', 'Фрейд Зигмунд', 1904);
insert into book (title, author, year_of_production)
